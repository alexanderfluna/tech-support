        ...
        <div className="faq-list">
          ...
          <div className="faq-item">
            ...
            {visibleAnswer === 'no-link-light' && (
              <div className="faq-answer">
                <p>1. For Devices with an 'A' and 'B' Pair:</p>
                <li>Ensure there is an A on one side and a B on the other.</li>
                <li>The devices only allow one strand of fiber, therefore the data must be transmitted and received over the one strand.</li>
                <li>The 'A' and 'B' units transmit and receive at different wavelengths.</li>
                <p>2. For Devices with Built-in Optics:</p>
                ...
                <p>3. For Devices Requring SFPs:</p>
                ...
                <p>4. Test the Fiber with Another Device.</p>
          ...
          <div className="faq-item">
            ...
            {visibleAnswer === 'no-poe' && (
              <div className="faq-answer">
                ...
                <p>3. Use a voltmeter to verify the power supply is producing 48 to 56VDC.</p>
                <li>Connect the red probe to the voltmeter's positive terminal and the black probe to the negative (or ground) terminal.</li>
                <li>Set the voltmeter to DC voltage mode.</li>
          ...
          <div className="faq-item">
            <button className="faq-question" onClick={() => toggleAnswer('no-communication')}> No Ethernet Port Activity </button>
            {visibleAnswer === 'no-communication' && (
              <div className="faq-answer">
                <p>1. Swap out the device with another known-working one to determine if the issue persists.</p>
                <p>2. Swap out the Ethernet cable to determine if the issue persists.</p>
              </div>
            )}
          </div>
        </div>
