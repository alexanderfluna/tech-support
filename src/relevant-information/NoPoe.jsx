...
const NoPoE = () => {
  return (
    <div>
      ...
      <p style={{paddingLeft: "40px"}}><strong>[2.4]</strong> If the voltage is less than 52VDC, increase the voltage. Otherwise, replace the power supply unit and recheck the voltage.</p>
