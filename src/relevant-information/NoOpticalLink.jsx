...
const NoOpticalLink = () => {
  return (
    <div>
      ...
      <p><strong>[4]</strong> If the link light remains solid green after removing the fiber, follow the procedure in the <strong>"How to Troubleshoot an Ethernet Switch with Power Issues"</strong> section to rule out power-related issues.</p>
    </div>
