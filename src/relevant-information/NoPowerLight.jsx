    ...
    <div className="faq-item">
      ...
      {visibleAnswer === 'no-power-light' && (
        <div className="faq-answer">
          ...
          <li>Touch the the red probe to the suspected positive terminal and the black probe to the suspected negative terminal. A positive voltage reading indicates correct polarity; a negative reading indicates reversed polarity.</li>
          <li>If the polarity is reversed, swap the wires and retry.</li>
          <p>[4] Determine if the power supply is delivering the required input/operating voltage.</p>
          <li>If the voltage is less or greater than the required input/operating voltage range, replace the power supply and redo step 3.</li>
          <li>If the voltage is within the required input/operating voltage range and the unit does not power on, contact technical support for an RMA.</li>
        </div>
      )}
    </div>
  );
